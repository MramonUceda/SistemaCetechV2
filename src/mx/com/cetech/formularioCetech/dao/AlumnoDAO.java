...
public class AlumnoDAO {
	...
	public Map<String, String> insertar(Alumno alumno) throws SQLException {
		...
		// 'licenciatura', 'Politecnico', 'Facebook', 'basico','otroscursos
		// creado por marioRamon')
		...
		try {
			...
			// System.out.println("Prueba de recibir Variable en el DAO 7: " +
			// alumno.getEdad());
			...
			// System.out.println("Prueba de recibir Variable en el DAO 20: " +
			// alumno.getRecomendacion());
	...
	public Alumno getAlumno(String nombre, String pass) throws SQLException {
		...
		dbConteccion = db.getDBConnection();
		try {
			ps = (PreparedStatement) dbConteccion.prepareStatement(sqlQuery);

			ps.setString(1, nombre);
			ps.setString(2, pass);
			rs = ps.executeQuery();
			while (rs.next()) {
				Alumno alumno = new Alumno(rs.getInt("idestudiante"), rs.getString("nombre"),
						rs.getString("apellidoPaterno"), rs.getString("apelldioMaterno"),
						rs.getString("correoElectronico"), rs.getString("curso"), rs.getString("formaDePago"),
						rs.getBoolean("activo"), rs.getString("contrasenia"), rs.getString("userName"),
						rs.getString("sexo"), rs.getString("fechaNacimiento"), rs.getString("telefono"),
						rs.getString("calle"), rs.getString("codigoPostal"), rs.getString("colonia"),
						rs.getString("estado"), rs.getString("delegacion"), rs.getString("ocupacion"),
						rs.getString("nivelAcademico"), rs.getString("escuela"), rs.getString("medio"),
						rs.getString("expectativas"), rs.getString("fechaRegistro"), rs.getString("fechaActualizacion"),
