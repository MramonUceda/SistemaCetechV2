...
public class ValidaFormulario extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("formaDePago: " + request.getParameter("formaDePago"));
		...
		System.out.println("codigoPostal: " + request.getParameter("codigoPostal"));
		System.out.println("colonia: " + request.getParameter("colonia"));
		System.out.println("delegacion: " + request.getParameter("delegacion"));
		...
		//System.out.println("recomendacion: " + request.getParameter("recomendacion"));
...
//		fechaActualizacion=fechaRegistro;
		...
		alumno.setFormaDePago(request.getParameter("formaDePago"));
		...
		alumno.setCodigoPostal(request.getParameter("codigoPostal"));
		alumno.setColonia(request.getParameter("colonia"));
		alumno.setEstado(request.getParameter("estado"));	
		alumno.setDelegacion(request.getParameter("delegacion"));
	...
	//	alumno.setRecomendacion(request.getParameter("recomendacion"));
